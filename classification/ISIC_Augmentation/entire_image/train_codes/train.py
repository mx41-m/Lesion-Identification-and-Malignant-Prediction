...
if __name__ == "__main__":
  ...
  parser.add_argument("--train_image_anno", default = './Data/Annotations/ISIC_augmentation/Entire_Image/Train/', type = str, help = 'Train images annotations')
  parser.add_argument("--val_image_anno", default = './Data/Annotations/ISIC_augmentation/Entire_Image/Val/', type = str, help = 'Val images annotations')
  parser.add_argument("--cls_num", default = 2, type = int, help = 'The number of classes for classification model')
  parser.add_argument("--save_path", default = '/Checkpoint/ISIC_Augmentation_Model/Entire_Image', type = str, help = 'Checkpoints save path for ISIC augmentation model')
