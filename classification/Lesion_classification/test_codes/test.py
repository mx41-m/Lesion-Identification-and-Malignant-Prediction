...
if __name__ == "__main__":
  ...
  parser.add_argument("--img_model_ck", default = 'Checkpoint/Lesion', type = str, help = 'Checkpoints path for Lesion classification model')
  parser.add_argument("--res_save_path", default = '/Results/Lesion/', type = str, help = 'Validation / Test results saving path for combine model')
